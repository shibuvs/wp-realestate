...
class WP_Real_Property {
    ...
    private function __construct() {
        ...
        add_action('init', [ $this, 'register_real_estate_post_type' ]);
    }

    /**
     * Get the singleton instance
     *
     * @return WP_Real_Property
     */
    ...
    /**
     * Registers the Real Estate custom post type
     */
...
// Initialize the WP_Real_Property class
